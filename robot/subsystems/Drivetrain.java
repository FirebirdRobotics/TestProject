...
public class Drivetrain extends SubsystemBase {
  ...
  public Drivetrain() {
    ...
    // deadband: if you accidentally move the joystick a small amnt, it won't move if speed is within deadband
  ...
  public void configTalon(WPI_TalonFX m_talon) {
    ...
    m_talon.configSupplyCurrentLimit(m_currentLimitConfig, 0);
  ...
  public void arcadeDrive(double forward, double turn) {
    m_diffDrive.arcadeDrive(forward * DriveConstants.kDriveSpeed, turn * DriveConstants.kTurnSpeed, false);
  ...
  public void driveWithEncoders(double targetEncoderCounts) {
    double targetZoneLower = targetEncoderCounts - (targetEncoderCounts * 0.05);
    double targetZoneUpper = targetEncoderCounts + (targetEncoderCounts * 0.05);
  ...
  public boolean doneDrivingEncoder(double targetEncoderCounts) {
    double targetZoneLower = targetEncoderCounts - (targetEncoderCounts * 0.05);
    double targetZoneUpper = targetEncoderCounts + (targetEncoderCounts * 0.05);
